...
The initial findings of this work are to be presented during [NIH Postbac poster day, 2020](https://www.training.nih.gov/postbac_poster_day). My poster is available in [this repository](poster/poster.pdf), and was generated with the wonderful R package [`posterdown`](https://github.com/brentthorne/posterdown). 
