...
```{r, include=TRUE, fig.cap="Leiden clustering by ontology similarity; HDBSCAN Clustering by Average HPO2Vec Embedding Space.", echo=FALSE}
...
The initial findings of this work are to be presented during [NIH Postbac poster day 2020](https://www.training.nih.gov/postbac_poster_day). My poster is available in [this repository](poster/poster.html), and was generated with the wonderful R package [`posterdown`](https://github.com/brentthorne/posterdown). 
